...
interface Resource {
  ...
  lesson_id: string
  title: string
  resource_type: "pdf" | "link" | "zip" | "video" | "code" | "image" | "doc" | "sheet"
  url?: string
  storage_key?: string
...
interface Lesson {
  ...
  title: string
  position: number
  kind: "video" | "article" | "quiz" | "live" | "pdf"
  description?: string
  video_provider?: "cloudflare" | "vimeo" | "youtube" | "custom"
  video_url?: string
  r2_key?: string
  blob_url?: string
  ...
  const createLessonResource = async () => {
    ...
    try {
      const body: any = {
        ...
        is_downloadable: resourceFormData.is_downloadable,
        status: resourceFormData.status,
      }

      if (resourceFormData.url) body.url = resourceFormData.url
      if (resourceFormData.storage_key) body.storage_key = resourceFormData.storage_key
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Select
                      value={currentLessonData.kind || "video"}
                      onValueChange={(value: any) => {
                        setCurrentLessonData({ ...currentLessonData, kind: value })
                        setHasUnsavedChanges(true)
                      }}
                    >
                      <SelectTrigger>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="flex gap-2">
                       <Select
                          value={currentLessonData.video_provider || "cloudflare"}
                          onValueChange={(value: any) => {
                             setCurrentLessonData({ ...currentLessonData, video_provider: value })
                             setHasUnsavedChanges(true)
                          }}
                        >
                ...
                <div>
                   <Label>Blob / Signed URL</Label>
                   <Input
                      value={currentLessonData?.blob_url || ""}
                      onChange={(e) => {
                         setCurrentLessonData({ ...currentLessonData, blob_url: e.target.value })
                         setHasUnsavedChanges(true)
                      }}
                      placeholder="Enter signed or blob URL (optional)"
                   />
                </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-2">
                      <Switch
                        checked={currentLessonData?.is_preview || false}
                        onCheckedChange={(checked) => {
                          setCurrentLessonData({ ...currentLessonData, is_preview: checked })
                          setHasUnsavedChanges(true)
                        }}
                      />
                     ...
                     <div className="flex items-center gap-2">
                      <Label>Status:</Label>
                      <Select
                          value={currentLessonData.status || "draft"}
                          onValueChange={(value: any) => {
                             setCurrentLessonData({ ...currentLessonData, status: value })
                             setHasUnsavedChanges(true)
                          }}
                        >
                  ...
                  <div className="space-y-2">
                    ...
                    {lessonResources.map((resource) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          {(resource.url || resource.storage_key) && (
                            <a
                              href={resource.url || resource.storage_key}
                              target="_blank"
          ...
          <div className="space-y-4 py-4">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value: any) => setResourceFormData({ ...resourceFormData, resource_type: value })}
              >
                <SelectTrigger>
                  <SelectValue placeholder="Select type" />
                </SelectTrigger>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center gap-2 pt-2">
                 <Switch
                    checked={resourceFormData.is_downloadable}
                    onCheckedChange={(checked) => setResourceFormData({ ...resourceFormData, is_downloadable: checked })}
                 />
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value: any) => setResourceFormData({ ...resourceFormData, status: value })}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Status" />
                  </SelectTrigger>
                ...
                <input
                  ...
                  onChange={async (e) => {
                    ...
                    if (file) {
                      ...
                      if (fileUrl) {
                        setResourceFormData({ ...resourceFormData, url: fileUrl, storage_key: `lesson-resources/${file.name}` })
                        toast({
                          title: "Success",
